function App_SaveState( ) {
	...
	function saveToLocalStorage( ) {
		...
		//	Saving Upgrade Data
		//==========================================
		var upgradeObj = SessionState.saveUpgrade( );
		key = Object.getOwnPropertyNames( upgradeObj );
		saveData[SessionState.saveSlot( )][key] = upgradeObj[key];
	...
	function loadFromLocalStorage( ) {
		...
		for( let i = 0; i < keyArray.length; i++ ) {
			...
			let saveTxt = "Run Time: " + saveDat["TimeRan"]["second"];
